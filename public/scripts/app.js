...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleDeleteOption(optionDelete) {
      console.log("delete opton called", optionDelete);
      this.setState(function (prevState) {
        return {
          options: prevState.options.filter(function (option) {
            return optionDelete !== option;
          })
        };
      });
    }
    ...
    value: function handlePick() {
      ...
      console.log(option);
      var pickedOption = this.state.options[option];
      alert(pickedOption);
    }
  }, {
    key: 'handleAddOption',
    value: function handleAddOption(option) {
      console.log("handle add option called");
      this.setState(function (prevState) {
        return {
    ...
    value: function render() {
      ...
      var subtitle = 'The decision of your life is in the hands of a computer';
